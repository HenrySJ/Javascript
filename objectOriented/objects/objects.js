...
// arg1: (this) object, arg2: name of property, arg3: an object with key value pair, (get: function(){}),
...
// Constructor Function
function Circle(radius) {
   this.radius = radius; // Public property of the cirlce object
   let defaultLocation = { x: 0, y: 0 }; // Private property of the circle object
   this.draw = function() {
       console.log('draw');
   };
// arg1: (this) object, arg2: name of property, arg3: an object with key value pair, (get: function(){}),
